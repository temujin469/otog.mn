...
function Footer() {
  return (
    <footer className="text-center text-gray-dark bg-gray-light pt-4">
        ...
        <div className="text-start grid lg:grid-cols-3 sm:grid-cols-2" >
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <ul className="list-none mb-0">
              ...
              <li>
                <a href="#!" className="footer-link">Хэрэглэгчээр бүртгүүлэх</a>
              </li>
              <li>
                <a href="#!" className="footer-link">Түгээмэл асуултууд</a>
              </li>
              <li>
                <a href="#!" className="footer-link">Холбоо барих</a>
              </li>
            </ul>
          </div>
      ...
      <div className="text-center text-gray-dark/60 p-4 bg-gray-dark/20">
        © 2022
        <a className="text-gray-dark/60" href="#"> Global Vision LLC</a>
      </div>
    </footer>
  )
}
