...
function SearchHeader({ fixed, withFilterRow }: any) {
  ...
  return (
    <div className={fixed ? 'md:fixed w-full md:bg-white z-[100]' : 'w-full md:bg-white'}>
      <div className=' text-gray select-none px-4 md:px-0 w-full h-[170px] md:h-auto shadow-md'>
        <div className='flex flex-col md:border-b border-gray md:flex-row md:divide-x divide-x-gray h-[60px]'>
          ...
          <div className=' hidden flex-[1] md:flex justify-end border-gray h-full md:relative items-center'>
            <ul className='flex items-center m-0 gap-5 px-5'>
              <li className="hover:text-secondary px-4 py-2 rounded-md hover:bg-black/20 h-[44px] flex items-center">
              ...
              <li className='relative h-[44px]'>
                <div className='text-gray cursor-pointer flex items-center gap-1 text-lg px-4 py-2 rounded-md hover:text-secondary  hover:bg-black/20' onClick={() => setShowProfile(!showProfile)}>
        ...
        <div className={withFilterRow ? 'block' : 'hidden'}>
          ...
          <div className='h-[50px] hidden md:flex border-b border-gray items-center gap-5 px-5 bg-white'>
            <button className='tag bg-primary text-white rounded-full py-3 px-3 md:py-1 md:px-3'>
              <GoSettings className='text-lg' /> <p className='hidden sm:block'>Шүүх & сортлох</p>
            </button>
            <button className='tag text-gray-dark py-3 px-3 md:py-1 md:px-3'>
