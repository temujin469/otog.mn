...
function Signup() {
  ...
  return (
    <div className="container h-screen md:h-auto">
      <form onSubmit={handleSubmit(handleSignup)} className="p-4 flex md:block justify-between flex-col">
        <div>
          <div className="mb-8">
            <label
        ...
        <button type="submit" className="inline-block left-5 absolute right-5 bottom-5 md:static bg-blue-400 font-medium text-white rounded shadow py-3 px-10 text-sm">
          Бүртгүүлэх
        </button>
      </form>
    </div>
